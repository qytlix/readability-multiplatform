...
export const SettingsIcon = () => (
  <Icon>
    ...
    <path d="M21.5 13.4v-2.8l-2-.7a7 7 0 0 0-.7-1.7l.9-1.9-2-2-1.9.9a7 7 0 0 0-1.7-.7l-.7-2h-2.8l-.7 2a7 7 0 0 0-1.7.7l-1.9-.9-2 2 .9 1.9a7 7 0 0 0-.7 1.7l-2 .7v2.8l2 .7a7 7 0 0 0 .7 1.7l-.9 1.9 2 2 1.9-.9a7 7 0 0 0 1.7.7l.7 2h2.8l.7-2a7 7 0 0 0 1.7-.7l1.9.9 2-2-.9-1.9a7 7 0 0 0 .7-1.7z" />
  </Icon>
);
