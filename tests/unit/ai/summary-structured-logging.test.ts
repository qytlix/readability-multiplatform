...
function createProfile(overrides: Partial<ActiveProviderProfile> = {}): ActiveProviderProfile {
  return {
    ...
    summaryModel: 'summary-test-model',
    translationProviderKind: 'openai',
    translationBaseUrl: 'https://translation-provider.example.test/v1',
    translationModel: 'translation-test-model',
    apiKeyRef: 'summary-test-secret-reference',
    translationApiKeyRef: 'translation-test-secret-reference',
    tagProviderKind: 'openai',
    tagBaseUrl: 'https://provider.example.test/v1',
    tagModel: 'gpt-5.4-mini',
    tagApiKeyRef: 'tag-test-secret-reference',
    chatProviderKind: 'openai',
    chatBaseUrl: 'https://provider.example.test/v1',
    chatModel: 'gpt-5.4-mini',
    chatApiKeyRef: 'summary-test-secret-reference',
    isActive: true,
