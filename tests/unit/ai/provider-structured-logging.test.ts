...
function createActiveProfile(
  ...
  return {
    ...
    chatApiKeyRef: 'stored-secret-reference',
    isActive: true,
...
function createPublicProfile(overrides: Partial<ProviderProfile> = {}): ProviderProfile {
  ...
  return {
    ...
    chatProviderKind: activeProfile.chatProviderKind,
    chatBaseUrl: activeProfile.chatBaseUrl,
    chatModel: activeProfile.chatModel,
    chatSupportsImages: activeProfile.chatSupportsImages,
